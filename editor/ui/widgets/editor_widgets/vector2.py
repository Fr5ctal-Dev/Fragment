...
from editor.ui.widgets.draggable_spinbox import DraggableSpinBox
...
class Vector2(EditorWidget):
    def __init__(self, *args, **kwargs):
        ...
        self.x_spin_box.setRange(-99999999999999999999.9, 99999999999999999999.9)
        self.y_spin_box.setRange(-99999999999999999999.9, 99999999999999999999.9)
