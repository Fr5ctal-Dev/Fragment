...
from editor.tools.utils.python import python_executable
...
class GameView(QtCore.QObject):
    ...
    def __init__(self, port):
        ...
        self.process.start(python_executable, [str(get_resource_path(Path('editor') / 'tools' / 'http_server' / 'view.py')), str(self.port)])
...
class HTTPServer(QtCore.QObject):
    ...
    def __init__(self, script_file, project_path):
        ...
        self.process.start(python_executable, ['-u', str(get_resource_path(Path('editor') / 'tools' / 'http_server' / 'main.py')), str(self.project_path)])
        self.port = None
