...
from editor.core.nodes.loader import node_properties as NODE_PROPERTIES
from editor.core.nodes.nodes.base_node import BaseNodeProperties
...
class NodeTree(QtWidgets.QTreeWidget):
    ...
    def new_node(self, type, parent=None, properties=None, uuid=None, name=None):
        ...
        item.setIcon(0, QtGui.QIcon(str(get_resource_path(Path('editor') / 'assets' / 'icons' / 'node' / f'{type}.png'))))
