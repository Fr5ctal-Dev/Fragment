...
class NewNodeSelectionDialog(SelectionDialog):
    def __init__(self, parent):
        ...
        with open(get_resource_path(Path('editor') / 'node_properties' / 'tree.vtree')) as f:
            content = f.read()
        ...
        for line in content.split('\n'):
            ...
            widget.setIcon(0, QtGui.QIcon(str(get_resource_path(Path('editor') / 'assets' / 'node_icons' / f'{line.strip()}.png'))))
